...
public class VeiculoController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> Inserir(InserirVeiculoViewModel viewModel)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Editar(Guid id, EditarVeiculoViewModel viewModel)
    {
        if (id != viewModel.Id)
